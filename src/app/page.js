    ...
    <>
      ...
      <div className="font-sans text-gray-800">
        ...
        <section id="categories" className="relative py-16 bg-gradient-to-r from-blue-50 to-white h-screen">
          <div className="absolute inset-0 bg-cover bg-center opacity-30" style={{ backgroundImage: "url('https://via.placeholder.com/1920x1080?text=Hero+BG')" }}></div>
          <div className="max-w-6xl mx-auto px-4 relative z-10">
            <h3 className="text-4xl font-bold text-center text-black mb-6">Popular Categories</h3>
              ...
              {[1, 2, 3].map((item) => (
                <div key={item} className="border-2 border-blue-200 rounded-xl p-6 hover:shadow-2xl hover:bg-blue-50 transition duration-300 transform hover:scale-105">
                  <div className="h-40 bg-gray-200 rounded-lg overflow-hidden mb-4">
                    <img src={`https://via.placeholder.com/400x200?text=Category+${item}`} alt={`Category ${item}`} className="w-full h-full object-cover transform transition duration-300" />
                  </div>
